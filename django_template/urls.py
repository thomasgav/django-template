...
schema_view = get_schema_view(
    openapi.Info(
        title="Template API",
        default_version="v1",
        description="API endpoints for Tempalte API",
        contact=openapi.Contact(email="thomasgavriilidis25@gmail.com"),
...
admin.site.site_title = "Tempalte API Admin Portal"
admin.site.index_title = "Welcome to Tempalte API Portal"
